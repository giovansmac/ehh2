    ...
    async buildChatflow(req, res, socketIO, isInternal = false, isUpsert = false) {
        ...
        try {
            ...
            if (isFlowReusable()) {
                ...
                const reactFlowNodeData = (0, utils_1.resolveVariables)(nodeToExecute.data, reactFlowNodes, incomingInput.question, incomingInput.history);
