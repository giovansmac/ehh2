import { IComponentNodes, IDepthQueue, INodeDependencies, INodeDirectedGraph, IReactFlowEdge, IReactFlowNode, INodeData, IOverrideConfig, ICredentialDataDecrypted, IComponentCredentials, ICredentialReqBody } from '../Interface';
 ...
 * @returns {string}
 */
export declare const getVariableValue: (paramValue: string, reactFlowNodes: IReactFlowNode[], question: string, chatHistory: IMessage[], isAcceptVariable?: boolean) => string;
/**
