...
exports.checkMemorySessionId = exports.redactCredentialWithPasswordType = exports.transformToCredentialEntity = exports.decryptCredentialData = exports.encryptCredentialData = exports.getEncryptionKey = exports.generateEncryptKey = exports.getEncryptionKeyPath = exports.isFlowValidForStream = exports.findAvailableConfigs = exports.mapMimeTypeToInputField = exports.replaceAllAPIKeys = exports.deleteAPIKey = exports.updateAPIKey = exports.getApiKey = exports.addAPIKey = exports.getAPIKeys = exports.compareKeys = exports.generateSecretHash = exports.generateAPIKey = exports.getAPIKeyPath = exports.isSameOverrideConfig = exports.isStartNodeDependOnInput = exports.replaceInputsWithConfig = exports.resolveVariables = exports.getVariableValue = exports.clearSessionMemoryFromViewMessageDialog = exports.clearAllSessionMemory = exports.buildLangchain = exports.getEndingNode = exports.getStartingNodes = exports.constructGraphs = exports.getNodeModulesPackagePath = exports.getUserHome = exports.databaseEntities = void 0;
...
const clearAllSessionMemory = async (reactFlowNodes, componentNodes, chatId, appDataSource, sessionId) => {
    ...
    for (const node of reactFlowNodes) {
        ...
        if (newNodeInstance.clearSessionMemory) {
            await (newNodeInstance === null || newNodeInstance === void 0 ? void 0 : newNodeInstance.clearSessionMemory(node.data, { chatId, appDataSource, databaseEntities: exports.databaseEntities, logger: logger_1.default }));
        }
    }
};
...
const isStartNodeDependOnInput = (startingNodes, nodes) => {
    ...
    for (const node of nodes) {
        if (whitelistNodeNames.includes(node.data.name))
            return true;
    }
    return false;
};
